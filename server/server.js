...
let loadStaticRoutes = () => new Promise((resolve, reject) => {
    ...
    server.app.get('/testwebsite/login', express.static(process.cwd()+"/LoginDemo/index.html"));
    server.app.get('/testwebsite/landingpage',express.static(process.cwd()+"/LoginDemo/Snow - By Visual Soldiers/index.html"))
